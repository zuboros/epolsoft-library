...
export const PATH_GET_BOOKS_BY_USER_ID = ({ id }) => `api/library/${id || ""}/books`;
...
//Users
export const PATH_GET_USERS = '/api/authors/get'
export const PATH_BLOCK_USERS = (id) => `/api/author/block/${id}`

//File/Avatar
export const PATH_UPLOAD_FILE = "/api/file/upload";

export const PATH_EXTRACT_FILE = (id) => `${process.env.REACT_APP_API_ADDRESS}/api/file/download/${id}?type=book`
export const PATH_EXTRACT_AVATAR = (id) => `${process.env.REACT_APP_API_ADDRESS}/api/file/download/${id}?type=avatar`